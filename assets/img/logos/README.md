...
Drop the OFFICIAL logo files here (PNG or SVG with transparent background, ~200×200 px, square-ish).
While a file is missing, the page shows a monogram fallback automatically.

| File               | Institution                                        | Brand source                          |
|--------------------|----------------------------------------------------|---------------------------------------|
...
| iafci.png          | IAFCI                                              | https://www.iafci.org                 |

To use SVG instead of PNG, change the file extension in index.html (`assets/img/logos/<name>.png`).
